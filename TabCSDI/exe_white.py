...
from dataset_white import get_dataloader

parser = argparse.ArgumentParser(description="TabCSDI")
parser.add_argument("--config", type=str, default="white.yaml")
...
foldername = "./save/white_fold" + str(args.nfold) + "_" + current_time + "/"
