...
print("RMSE_notmiwae selfmasking = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae_selfmasking2), np.std(RMSE_notmiwae_selfmasking)))
print("RMSE_notmiwae linear = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae_linear2), np.std(RMSE_notmiwae_linear)))
