...
RMSE_miwae4 = []
RMSE_notmiwae4 = []
RMSE_notmiwae_selfmasking4 = []
RMSE_notmiwae_linear4 = []
RMSE_mean4 = []
RMSE_mice4 = []
RMSE_RF4 = []
...
for _ in range(runs):
    ...
    # ---- find imputation RMSE
    RMSE_miwae4.append(utils.imputationRMSE(miwae, Xtrain, Xz, Xnan, S, L)[0])
    ...
    # ---- find imputation RMSE
    RMSE_notmiwae4.append(utils.not_imputationRMSE(notmiwae, Xtrain, Xz, Xnan, S, L)[0])
    ...
    # ---- find imputation RMSE
    RMSE_notmiwae_selfmasking4.append(utils.not_imputationRMSE(notmiwae, Xtrain, Xz, Xnan, S, L)[0])
    ...
    # ---- find imputation RMSE
    RMSE_notmiwae_linear4.append(utils.not_imputationRMSE(notmiwae, Xtrain, Xz, Xnan, S, L)[0])
...
print("URL3")
print("Data Shape: ", data_shape)
print("RMSE_miwae = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_miwae3), np.std(RMSE_miwae3)))
print("RMSE_notmiwae selfmasking_known = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae3), np.std(RMSE_notmiwae3)))
print("RMSE_notmiwae selfmasking = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae_selfmasking3), np.std(RMSE_notmiwae_selfmasking3)))
print("RMSE_notmiwae linear = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae_linear3), np.std(RMSE_notmiwae_linear3)))


print("URL4")
print("Data Shape: ", data_shape)
print("RMSE_miwae = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_miwae4), np.std(RMSE_miwae4)))
print("RMSE_notmiwae selfmasking_known = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae4), np.std(RMSE_notmiwae4)))
print("RMSE_notmiwae selfmasking = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae_selfmasking4), np.std(RMSE_notmiwae_selfmasking4)))
print("RMSE_notmiwae linear = {0:.5f} +- {1:.5f}".format(np.mean(RMSE_notmiwae_linear4), np.std(RMSE_notmiwae_linear4)))